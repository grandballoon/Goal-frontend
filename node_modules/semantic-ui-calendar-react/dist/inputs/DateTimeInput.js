...
var DateTimeInput = function (_BaseInput) {
    ...
    _this.handleSelectUndelayed = function (e, _ref4) {
      ...
      _this.setState(function (prevState) {
        ...
        if (mode !== 'minute') {
          ...
          var timeFormatStr = _parse.TIME_FORMAT[_this.props.timeFormat];
          var outValue = (0, _moment2.default)(value).format('' + _this.props.dateFormat + _this.props.divider + timeFormatStr);
  ...
  _createClass(DateTimeInput, [{
    ...
    value: function getPicker() {
      ...
      var dateTimeFormat = '' + dateFormat + divider + _parse.TIME_FORMAT[timeFormat];
      var pickerProps = {
        displayWeeks: true,
        hasHeader: true,
        ...
        value: (0, _parse.parseValue)(value, dateTimeFormat),
