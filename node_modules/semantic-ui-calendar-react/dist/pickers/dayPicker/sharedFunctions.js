...
function getDisabledDays(disable, maxDate, minDate, date, daysOnPage) {
  var dayPositions = _lodash2.default.range(daysOnPage);
  var daysInCurrentMonthPositions = getDefaultEnabledDayPositions(buildDays(date, daysOnPage), date);
